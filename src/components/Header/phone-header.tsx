...
export default function PhoneHeader() {
  ...
  return (
    <div className="relative flex items-center justify-between bg-mainColorBlue p-4 px-6">
      ...
      {showMenu ? (
        <div className="fixed top-[100px] z-[999] m-auto  w-[90%] rounded-xl bg-mainColorBlue/90 p-10">
          ...
          <nav className="OpenSans flex flex-col space-y-14 text-2xl font-semibold text-mainColorWhite ">
            <NavbarLinks />
          </nav>
        </div>
      ) : (
