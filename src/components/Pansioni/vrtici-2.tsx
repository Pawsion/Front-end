...
export default function VrticiTwo() {
  return (
    <div className="lg:my-20 space-y-10 md:space-y-16 text-2xl">
      <h3 className="text-3xl md:text-5xl font-bold font-RobotoSlab leading-tight">
        Šta uključuje boravak u vrtiću?
      </h3>
      <div className="flex flex-col items-center justify-between md:flex-row">
        <div className="space-y-8 md:space-y-10 xl:space-y-16 md:w-1/2">
