...
const FoodHeader: React.FC = () => {
  const title = "Кako izabrati najbolju hranu za pse - Lista brendova za 2024.";
  ...
  const content = [
    ...
    "Promena u kvalitetu života dovela je do nicanja mnoštva brendova i vrsta hrane za pse, ostavivši vlasnike u nedoumici koja je hrana najbolja za njihove krznene prijatelje.",
