...
export default function PansioniPage() {
  return (
    <div className="">
      ...
      <div id="beograd"><PansioniPoGradu city="Beograd" /></div>
      <div id="novi-sad"><PansioniPoGradu city="Novi Sad" /></div>
      <div id="subotica"><PansioniPoGradu city="Subotica" /></div>
      <div id="nis"><PansioniPoGradu city="Niš" /></div>

      <div id="vrtici" className="m-auto w-3/4 space-y-20">
        <Vrtici />
        <div className="xl:text-2xl"> 
          <p>
            Radno vreme najčešće kreće od 7 ili 9 sati ujutru tako da je prilagođeno poslovnim obavezama vlasnika pasa.<br />
            Cene su raznolike od grada do grada, a vrići često imaju <b>mesečne pakete</b> koji vam omogućavaju dodatni<br /> popust.
          </p>
          <p className="mt-16 mb-64">
            Da bi pas bio prihvaćen u pansion mora biti vakcinisan i socijalizovan. 
          </p>
        </div>
        <VrticiTwo />
        <Prednosti />
