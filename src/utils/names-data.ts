export type NameListData = {
  ...
  export const femaleDogNames: NameListData = {
    ...
    description: 'Tajna pronalaženja najjedinstvenijih imena za ženske pse je da pronađete ime sa ličnošću i šarmom. Ono treba da bude ženstveno, da ima snagu, deluje zabavno i samouvereno. Inspiracija mogu da vam budu omiljeni [b]likovi iz filmova, knjiga, priroda, razna božanstva i još mnogo toga.[/b]',
  ...
  export const maleDogNames: NameListData = {
    ...
    description: 'Kada su muška imena u pitanju, inspiraciju možete pronaći u [b]superherojima, planetama, crtanim i filmskim[/b] [b]likovima.[/b] Prepustite se mašti, granica ne postoji. Pogledajte spisak imena koje smo izdvojili za vas:',
  ...
  export const shortDogNames = {
    ...
    description: 'Imena sa jednim slogom su uvek dobitna kombinacija - imaju kratke i isprekidane zvuke zbog kojih psi brzo reaguju i lako ih razumeju. Nećete pogrešiti ni ako izaberete ime sa dva sloga. Sluh pasa je otprilike četiri puta osetljiviji od našeg, a [b]imena sa dva sloga kada se izgovaraju stvaraju promenu u frekvenciji i tako privlače pažnju psa.[/b] Takođe, ime sa dva sloga omogućava naglašavanje, što pomaže u prikazivanju emocija. Na primer, kada prvi slog izgovarate višim tonom od drugog, izražavate naklonost. Ako počnete sa nižim tonom, a zatim pređete na viši, time pokazujete da ste nezadovoljni ponašanjem svog ljubimca. Evo nekoliko predloga muških i ženskih imena:',
    maleNames: [
  ...
  export const powerfulDogNames = {
    ...
    description: 'Bez obzira da li govorimo o fizičkoj snazi, jakoj ličnosti ili karakteru, verujemo da postoje mnogi psi koji zaslužuju ovakva imena. Inspiraciju za moćna imena uvek možete potražiti u [b]mitologiji, istorijskim ili filmskim[/b][b] ličnostima, herojima, kraljevskim dinastijama.[/b] Nadamo se da ćete među našim predlozima pronaći baš ono pravo.',
